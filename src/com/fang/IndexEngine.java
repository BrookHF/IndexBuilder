...
class IndexEngine {
    ...
    IndexEngine(String adsDataFilePath, String budgetDataFilePath, String memcachedServer,
                       int memcachedPortal, String mysqlHost, String mysqlDb, String userName, String passWord) {
        mAdsDataFilePath = adsDataFilePath;
        mBudgetFilePath = budgetDataFilePath;
        indexBuilder = new IndexBuilder(memcachedServer, memcachedPortal, mysqlHost, mysqlDb, userName, passWord);
    }
